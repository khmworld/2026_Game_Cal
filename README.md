...
입력 데이터는 프로젝트 내 로컬 파일을 기준으로 읽어오며, 기본적으로 실행 디렉터리(프로젝트 루트) 아래의 파일을 사용합니다.

- 예시 입력 파일 위치: `./calendar.md`, `./data/`, `./input/`
...
`GameCalendar.spec`는 **one-dir(디렉터리 배포)** 구성을 사용하며, 다음 리소스를 함께 포함합니다.
